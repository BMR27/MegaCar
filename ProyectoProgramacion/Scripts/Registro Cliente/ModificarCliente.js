...
function EventosClick() {
    $("#btnModificar").on("click", function () {
        var formulario = $("#frmRegistraCliente");
        formulario.validate();
        if (formulario.valid()) {
...
function CapturaDatosModificar() {
    var urlMetodo = '/Cliente/MofificarDatosCliente'
    var parametros = {
        C_NOMBRE_CLIENTE: $("#C_NOMBRE_CLIENTE").val(), 
        C_APELLIDO1: $("#C_APELLIDO1").val() ,
        C_APELLIDO2: $("#C_APELLIDO2").val(),
        C_CEDULA: $("#C_CEDULA").val(),
        C_CORREO: $("#C_CORREO").val(),
        C_DIRECCION: $("#C_DIRECCION").val(),
        C_TELEFONO: $("#C_TELEFONO").val(),
        C_FK_PROVINCIA: $("#C_FK_PROVINCIA").val(),
        C_FK_CANTON: $("#C_FK_CANTON").val(),
        C_FK_DISTRITO: $("#C_FK_DISTRITO").val()
    }
...
function MostrarAlertaExito() {
    $('#divMensaje').fadeTo(2000, 500).slideUp(500, function () {
        $("#divMensaje").slideUp(500);
    }); //muestro mediante id
}
///crea las validaciones para el formulario
function ValidarFormularioModifica() {
